...
> Para acceder a la versión completa conectada al backend en Flask + GraphQL, vuelve a la rama principal [`master`](https://github.com/EnriqueTorralboRamos/Shop-Vue/tree/master).
